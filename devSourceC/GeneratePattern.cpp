...
inline void GeneratePatternPT(int sizeTheta, float *  II, float *  r, int sizeR, complex<float> m, float *  pii, float *  tau,
...
void GeneratePattern(float *  II, float *  r, const int sizeR, complex<float> m,
