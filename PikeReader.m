...
handles.S.N = 20; %5e2 ; % Number of points per side
...
if handles.GPU==1
    ...
    PXYT=PXY;
    PXZT=PXZ;
    save('compT20.mat','ICT','THETAT','PHIT','RT','PXXT','PXYT','PXZT','ICNNT');
else
Br = single(BorderCreation(hObject,handles));
...
PHIG=PHI;
RG=R;
save('compG20.mat','ICG','THETAG','PHIG','RG','PXXG','PXYG','PXZG','KA1','KA2','KA3','KA4','KA5','KA6','ICNNG');
end
%f=figure;
%imtool(IC);
%THETA
