...
function handles = Draw(hObject,handles)
    ...
    if get(handles.chSumFrames,'value')
        ...
        if ~isempty(handles.sF)
            ...
            h = errordlg('Frames` Sum not found','Workspace Error'); uiwait(h);
            temp = handles.cF;
...
Save = evalin('base','Save');
    ...
    h = errordlg('Load Parameters into Workspace','Workspace Error'); uiwait(h);
    return
end
...
if get(handles.chSumFrames,'value') % get sum frames
        if ~isempty(handles.sF)
           temp = handles.sF;
        else
            % if there isn't sum of frame, then draws current frame instead
...
if get(handles.chR,'value') % mask for red channel
    ...
    position = wait(h);
    delete(hf);
    Bw1 = roipoly(temp(:,:,1),[position(:,1).' position(1,1)],[position(:,2).' position(1,2)]);
    % mask from aperture
    Bw2 = roipoly(temp(:,:,1),get(handles.hl(1),'xdata'),get(handles.hl(1),'ydata'));
...
if get(handles.chG,'value') % mask for green channel
    ...
    position = wait(h);
    delete(hf);
    Bw1 = roipoly(temp(:,:,2),[position(:,1).' position(1,1)],[position(:,2).' position(1,2)]);
    % mask from aperture
    Bw2 = roipoly(temp(:,:,2),get(handles.hl(4),'xdata'),get(handles.hl(4),'ydata'));
...
if get(handles.chB,'value') % mask for blue channel
    ...
    position = wait(h);
    delete(hf);
    Bw1 = roipoly(temp(:,:,3),[position(:,1).' position(1,1)],[position(:,2).' position(1,2)]);
    % mask from aperture
    Bw2 = roipoly(temp(:,:,3),get(handles.hl(7),'xdata'),get(handles.hl(7),'ydata'));
...
if get(handles.chR,'value') % mask for red channel background
    ...
    Bw2 = roipoly(temp(:,:,1),get(handles.hl(1),'xdata'),get(handles.hl(1),'ydata'));
    % compound of masks  for red channel
    Bw3 = roipoly(temp(:,:,1),get(handles.hl(4),'xdata'),get(handles.hl(4),'ydata'));
    Bw4 = roipoly(temp(:,:,1),get(handles.hl(7),'xdata'),get(handles.hl(7),'ydata'));
...
if get(handles.chG,'value') % mask for green channel background
    Frame(:,:,2)=temp(:,:,2);% ./ max(max(temp(:,:,2))) .* 10;
    hf = imtool( Frame(:,:,2),[min(min(Frame(:,:,2))),max(max(Frame(:,:,2)))] );
    ...
    Bw1 = roipoly(temp(:,:,2),[position(:,1).' position(1,1)],[position(:,2).' position(1,2)]);
    % mask from aperture
    Bw2 = roipoly(temp(:,:,2),get(handles.hl(1),'xdata'),get(handles.hl(1),'ydata'));
    % compound of masks  for green channel
    Bw3 = roipoly(temp(:,:,2),get(handles.hl(4),'xdata'),get(handles.hl(4),'ydata'));
    Bw4 = roipoly(temp(:,:,2),get(handles.hl(7),'xdata'),get(handles.hl(7),'ydata'));
...
if get(handles.chB,'value') % mask for blue channel background
    Frame(:,:,3)=temp(:,:,3);% ./ max(max(temp(:,:,3))) .* 10;
    ...
    Bw1 = roipoly(temp(:,:,3),[position(:,1).' position(1,1)],[position(:,2).' position(1,2)]);
    % mask from aperture
    Bw2 = roipoly(temp(:,:,3),get(handles.hl(1),'xdata'),get(handles.hl(1),'ydata'));
    % compound of masks  for blue channel
    Bw3 = roipoly(temp(:,:,3),get(handles.hl(4),'xdata'),get(handles.hl(4),'ydata'));
    Bw4 = roipoly(temp(:,:,3),get(handles.hl(7),'xdata'),get(handles.hl(7),'ydata'));
