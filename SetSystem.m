...
S.D    = 11.87;%12.4-2*0.14142;   % lens diametr. Set 15 instead of 12.5 (real aperture) is convenient for calculations
                        % 0.2 is th edge cut --> 0.14142 in diam. and length 
                        % actually the inner diameter of the obkective tube
...
S.RDph  = 10; %0.5;   % Radius of aperture - big chamber
